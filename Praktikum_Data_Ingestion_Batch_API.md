...
6. Struktur Project
7. Percobaan 0 — Menyiapkan Local Mock API
8. Percobaan 1 — Dasar Data Ingestion dan HTTP
9. Percobaan 2 — Pagination
10. Percobaan 3 — Rate Limiting dan HTTP 429
11. Percobaan 4 — Retry, Exponential Backoff, dan Jitter
12. Percobaan 5 — Incremental Loading dan Watermark
13. Percobaan 6 — Clean Code dan Modular Python
14. Percobaan 7 — Logging dan Observability
15. Percobaan 8 — Validasi Data
16. Percobaan 9 — Apache Parquet
17. Percobaan 10 — Pipeline End-to-End
18. Percobaan 11 — Strategi Penyimpanan Batch dan Partitioning
...
Setelah menyelesaikan modul ini, mahasiswa mampu membangun pipeline ingestion berbasis API 
...
# 6. PERCOBAAN 0 — MENYIAPKAN LOCAL MOCK API
...
# 7. PERCOBAAN 1 — DASAR DATA INGESTION DAN HTTP
...
# 8. PERCOBAAN 2 — PAGINATION

# 8.1 Page Number Pagination
...
# 8.2 Kesalahan Umum: Lupa Menaikkan Nomor Halaman
...
# 8.3 Pagination dengan Generator
...
# 9. PERCOBAAN 3 — RATE LIMITING DAN HTTP 429
...
# 25. TROUBLESHOOTING - PERMASALAHAN YANG MUNGKIN TIMBUL SELAMA PRAKTIKUM (Tidak untuk dipraktikumkan)
...
# 34. DOKUMENTASI YANG HARUS DIKUMPULKAN 
